...
def seeder():
    ...
    print('----Customers----')
    customers = [
        Customer(id=1, customerName="○○株式会社", customerKana='かぶしきがいしゃ', honorificTitle='御中', department='部署名', postNumber='000-0000',
                 ...
                 memo='これは○○株式会社のメモです',),
        Customer(id=2, customerName="○○有限会社", customerKana='ゆうげんがいしゃ', honorificTitle='御中', department='部署名', postNumber='111-1111',
                 ...
                 memo='これは○○有限会社のメモです',),
        Customer(id=3, customerName="○○商事", customerKana='しょうじ', honorificTitle='御中', department='部署名', postNumber='222-2222',
