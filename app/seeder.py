...
def seeder(v=False):
    ...
    totalInvoices = [
        TotalInvoice(totalInvoiceApplyNumber=220001,
                     applyNumbers="220001", customerId=1, issueDate=date(2022, 1, 1), title="合計請求書１", fileName=""),
        TotalInvoice(totalInvoiceApplyNumber=220002,
                     applyNumbers="220002", customerId=2, issueDate=date(2022, 1, 1), title="合計請求書２", fileName=""),
        TotalInvoice(totalInvoiceApplyNumber=220003,
                     applyNumbers="220003", customerId=3, issueDate=date(2022, 1, 1), title="合計請求書３", fileName=""),
    ]
