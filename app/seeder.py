...
def seeder():
    ...
    setting = [
        Setting(id=1, companyName='自社株式会社', registerNumber=1111111111111, representative='自社代表者', administrator='管理者太郎', postNumber='000-0000', address='宇都宮市北若松原',
                ...
                isDisplayQuotationStamp=True, isDisplayInvoiceStamp=True, isDisplayDeliveryStamp=True, defaultTax=10, contrast=0, isMemoQuadrupleIndicate=False, memoLabel1='年式', memoLabel2='型式', memoLabel3='型番', memoLabel4='走行距離',)
    ]
