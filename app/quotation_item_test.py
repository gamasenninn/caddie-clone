...
class BasicTest(unittest.TestCase):
    ...
    def test_create_quotation_item(self):
        ...
        quotationItems = [
            Quotation_Item(quotationId=3, itemId=2, price=100, count=20),
            Quotation_Item(quotationId=3, itemId=3, price=200, count=10),
        ]
    ...
    def test_delete_quotation_item(self):
        ...
        quotationItem = Quotation_Item(
            quotationId=1, itemId=1, price=999, count=10)
